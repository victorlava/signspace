...
/* eslint jsx-control-statements/jsx-use-if-tag: 0 */
/*!
...
const Select = React.createClass({
	...
	propTypes: {
        ...
        onValueSelect: React.PropTypes.func,        // extra handler used on selectValue(), look at Creatable.js
	...
	renderInput (valueArray, focusedOptionIndex, options, focusedOption) {
        ...
        // INFO: currently we want to create one type of input component
	...
	renderOuter (options, valueArray, focusedOption) {
        ...
        // do not return menu if it's empty
        if (menu !== null) {
		...
		return (
            ...
            >
                ...
                <div
                    ...
                    onTouchMove={this.handleTouchMove}
                >
                    <div className="Select-addressed-to">Addressed to</div>
					<span className="Select-multi-value-wrapper" id={this._instancePrefix + '-value'}>
						{this.renderValue(valueArray, isOpen)}
						{this.renderInput(valueArray, focusedOptionIndex, options, focusedOption)}
					</span>
					{removeMessage}
					{this.renderLoading()}
					{this.renderClear()}
